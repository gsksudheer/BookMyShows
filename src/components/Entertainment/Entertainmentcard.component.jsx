    ...
    return (
        <>
         <div className="w-full h-30 px-2 ">
            <img className="w-full h-full rounded-xl" src={props.src} alt="Loading......." />
        </div>
...
const EntertainmentCardSlider = () => {
  ...
  //  const [EntertainmentImages, setEntertainmentImages] = Use([]);
    


    const EntertianmentImages = [
